                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        ...
                        <p className="mt-4 text-sm text-gray-400 leading-relaxed">
                            Connect with top talent and find your dream job. The leading marketplace for professional opportunities.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/jobs" className="text-sm hover:text-white transition-colors">Find Work</Link></li>
                            ...
                            <li><a href="#" className="text-sm hover:text-white transition-colors">Skill Tests</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link href="/jobs/post" className="text-sm hover:text-white transition-colors">Post a Job</Link></li>
                            <li><a href="#" className="text-sm hover:text-white transition-colors">Find Talent</a></li>
                            <li><a href="#" className="text-sm hover:text-white transition-colors">Enterprise</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#" className="text-sm hover:text-white transition-colors">Trust & Safety</a></li>
